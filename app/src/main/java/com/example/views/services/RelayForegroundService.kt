...
class RelayForegroundService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "psilo_relay_channel"
        private const val CHANNEL_NAME = "Psilo relay connection"
    ...
    private fun buildNotification(followingCount: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("Psilo is running")
            .setContentText(contentText)
            .setSmallIcon(com.example.views.psilo.R.drawable.ic_notification_frog)
            .setOngoing(true)
